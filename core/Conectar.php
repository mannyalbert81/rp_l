    ...
    public function conexion(){
       //holas 
        if($this->driver=="pgsql" || $this->driver==null){
            $con = pg_connect("host=186.4.157.125 port=5432 dbname=rp_capremci user=postgres password=Programaodres2018");
         	if(!$con){
    ...
    public function startFluent(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
        	...
        	try
        	{
        		...
        		$pdo = new PDO('pgsql:host=186.4.157.125;port=5432;dbname=rp_capremci', 'postgres', '.romina.2012' );
