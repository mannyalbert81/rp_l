...
$template = file_get_contents('view/reportes/template/ReporteDesafiliacion.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteDesafiliacion.css'); // la ruta a tu css
