...
$template = file_get_contents('view/reportes/template/FichaActivosReporte.html');
...
$stylesheet = file_get_contents('view/reportes/template/FichaActivos.css'); // la ruta a tu css
