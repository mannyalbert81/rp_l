...
$template = file_get_contents('view/reportes/template/ProductosReporte.html');
...
$stylesheet = file_get_contents('view/reportes/template/ProductosReporte.css'); // la ruta a tu css
