...
$template = file_get_contents('view/reportes/template/ReporteLiquidacion.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteLiquidacion.css'); // la ruta a tu css
