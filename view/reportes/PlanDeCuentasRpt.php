...
$template = file_get_contents('view/reportes/template/PlanDeCuentas.html');
...
$stylesheet = file_get_contents('view/reportes/template/PlanDeCuentas.css'); // la ruta a tu css
