...
$template = file_get_contents('view/reportes/template/ReporteMovimientosProductos.html');
...
if(!empty($cabecera_producto))
{
    
    foreach ($cabecera_producto as $clave=>$valor) {
        echo $clave; echo "\n";
        $template = str_replace('{'.$clave.'}', $valor, $template);
    }
}
...
$stylesheet = file_get_contents('view/reportes/template/ReporteMovimientosProductos.css'); // la ruta a tu css
