...
<html lang="en">
  <head>
    ...
    <title>Liventy - Orden Pago</title>
 ...
 <?php  $dias = array("Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sábado");
  ...
  <div class="content-wrapper">
        ...
        <section class="content">
          <form id="frm_avoco_orden_pago" action="<?php echo $helper->url("AvocoOrdenPago","InsertAvoco"); ?>" method="post" enctype="multipart/form-data"  class="form form-horizontal">
                ...
                <div id="step-1" class="">
                    ...
                    <div class="row">
        	    	  <div class="col-lg-6 col-md-6 col-xs-12">
                         ...
                         <div class="form-group "> 
                    			 <div class="form-group-sm">
                    				<label for="fecha_titulo_credito_juicios" class="col-sm-4 control-label" >Fecha Titulo Crédito:</label>
                    				<div class="col-sm-4">
                    				  <input type="text" class="form-control" id="fecha_titulo_credito_juicios" name="fecha_titulo_credito_juicios" value="<?php echo $resEdit->fecha_titulo_credito_juicios; ?>" readonly>
                    				</div>
                    			 </div>        			 
                			</div> 
                      		...
                      		<div class="form-group "> 
                    			 <div class="form-group-sm">
                    				<label for="cuantia_inicial_juicios" class="col-sm-4 control-label" >Cuantia Inicial:</label>
                    				<div class="col-sm-4">
                    				  <input type="text" class="form-control" id="cuantia_inicial_juicios" name="cuantia_inicial_juicios" value="<?php echo $resEdit->cuantia_inicial_juicios; ?>" readonly>
                    				</div>
                    			 </div>        			 
                			</div> 
                		...
                		<div class="col-lg-6 col-md-6 col-xs-12">
                          ...
                          <div class="form-group "> 
                    			 <div class="form-group-sm">
                    				<label for="orden_cobro_juicios" class="col-sm-4 control-label" >N° Orden Cobro:</label>
                    				<div class="col-sm-4">
                    				   <input type="text" class="form-control" id="orden_cobro_juicios" name="orden_cobro_juicios"  value="<?php echo $resEdit->orden_cobro_juicios; ?>" readonly>
                                    </div>
                    			 </div>        			 
                		  </div>
                         ...
                         <div class="form-group "> 
                    			 <div class="form-group-sm">
                    				<label for="fecha_oden_cobro_juicios" class="col-sm-4 control-label" >Fecha Orden Cobro:</label>
                    				<div class="col-sm-4">
                    				  <input type="text" class="form-control" id="fecha_oden_cobro_juicios" name="fecha_oden_cobro_juicios" value="<?php echo $resEdit->fecha_oden_cobro_juicios; ?>" readonly>
                    				</div>
                    			 </div>        			 
                			</div> 
        	    	  ...
        	    	  <div class="col-lg-6 col-md-6 col-xs-12">
                         ...
                         <div class="form-group "> 
                    			 <div class="form-group-sm">
                    				<label for="fecha_titulo_credito_juicios" class="col-sm-4 control-label" >Fecha Titulo Crédito:</label>
                    				<div class="col-sm-4">
                    				  <input type="text" class="form-control" id="fecha_titulo_credito_juicios" name="fecha_titulo_credito_juicios" value="" readonly>
                    				</div>
                    			 </div>        			 
                			</div> 
                		...
                		<div class="col-lg-6 col-md-6 col-xs-12">
                		 ...
                		 <div class="form-group "> 
                    			 <div class="form-group-sm">
                    				<label for="orden_cobro_juicios" class="col-sm-4 control-label" >N° Orden Cobro:</label>
                    				<div class="col-sm-4">
                    				   <input type="text" class="form-control" id="orden_cobro_juicios" name="orden_cobro_juicios"  value="" readonly>
                                    </div>
                    			 </div>        			 
                		  </div>
                         ...
                         <div class="form-group "> 
                    			 <div class="form-group-sm">
                    				<label for="fecha_oden_cobro_juicios" class="col-sm-4 control-label" >Fecha Orden Cobro:</label>
                    				<div class="col-sm-4">
                    				  <input type="text" class="form-control" id="fecha_oden_cobro_juicios" name="fecha_oden_cobro_juicios" value="" readonly>
                    				</div>
                    			 </div>        			 
                			</div> 
   ...
   <script src="view/bootstrap/plugins/input-mask/jquery.inputmask.js"></script>
	...
	<script type="text/javascript" src="view/Juridico/js/AvocoOrdenPago.js?0.10"></script>
	<script type="text/javascript" src="view/Juridico/js/wizardAvocoOrdenPago.js?0.6"></script>
