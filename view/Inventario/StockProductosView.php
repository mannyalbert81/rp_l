        ...
        <section class="content">
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form id="frm_depreciacionGeneral" action="<?php echo $helper->url("StockProductos","stock_productos"); ?>" method="post" enctype="multipart/form-data" class="col-lg-12 col-md-12 col-xs-12">
                     	...
                     	<div class="row">
    	        		    ...
    	        		    <div class="col-xs-12 col-md-12 col-md-12 " style="margin-top:15px;  text-align: center; ">
            	                  ...
            	                  <input type="image" src="view/images/pdf.png" alt="Submit" width="100" height="100" formtarget="_blank" id="btngenerar" name="btngenerar" class="btn btn-default">
            	                   <br> 
            	                   <label  class="control-label">Revisar Stock</label>
            	                  </div>
    	        		    </div>
            		    </div>
